...
public class PhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        params.height = ScreenUtils.getScreenWidth(mContext) /4;
    ...
    final PhotoInfo photoInfo;
        ...
        galleryConfig.getImageLoader().displayImage(mActivity, mContext, photoInfo.path, viewHolder.ivPhotoImage, ScreenUtils.getScreenWidth(mContext) / 4, ScreenUtils.getScreenWidth(mContext) / 4);
