 ...
 */
public class PhotoCorpDialog extends BaseDialog {
    ...
    public PhotoCorpDialog(BaseActivity activity, int size) {
        super(activity);
        mActivity = activity;
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.llcamera:
                    GalleryPick.getInstance().setGalleryConfig(ConfigHelper.getInstance().getPhotoConfig(iHandlerCallBack,false)).open(mActivity);
                    break;
                case R.id.llPhote:
