...
public class AdsFragment extends BaseFragment {
    ...
    private LeftFragment babyFragment;
    private RightFragment publicVidioFragement;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_ads, container, false);
    ...
    public void initView() {
        ...
        babyFragment=new LeftFragment();
        publicVidioFragement=new RightFragment();
