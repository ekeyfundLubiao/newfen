...
import com.m086.ad.mobi.view.ads.AddAdsActivity;
...
public class SendAdsAdapter extends RecyclerView.Adapter<SendAdsAdapter.MyViewHold> {


    private AddAdsActivity mContext;
    ...
    public SendAdsAdapter(AddAdsActivity context, SentPicBean items) {
