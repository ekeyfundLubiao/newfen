...
public class SysConfig {
    ...
    //上传网址
    public final static String UploadUrl = "http://115.29.165.57:8080/teachjobfileserver/httpserver";
    //文件服务器地址
    public final static String FileUrl = "http://115.29.165.57:8080/teachjobfileserver/upload/";
    public final static int port = 8080;
    public static String NewMsgCount = "0";
    public static final String File_DIR = "newcloud";
    //
    public static long lastupdatetime = new Date().getTime();
    //uid
