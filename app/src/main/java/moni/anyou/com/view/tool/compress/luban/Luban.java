package moni.anyou.com.view.tool.compress.luban;
...
import static moni.anyou.com.view.tool.compress.luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    private static String DEFAULT_DISK_CACHE_DIR = "anyouFile";
    ...
    private static File getPhotoCacheDir(Context context, String cacheName) {
        File file = new File(SDPATH + "//anyou" + "//" + cacheName);
